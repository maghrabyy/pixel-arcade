        ...
        <div className="about-me flex sm:items-stretch items-center py-4">
            <TransparentContainer expanded={false} className="sm:h-full">
                <Reveal className="flex flex-col items-center gap-4 h-full">
                    <DeveloperInfo/>
                    <div className="panel bg-white w-full h-full px-4 pb-4 rounded-t-md">
                        <DeveloperSkills/>
...
const DeveloperInfo = ()=>{
    return <div className="dev-info flex flex-col gap-1 items-center">
...
const DeveloperSkills = ()=>{
    return <div className="skills self-start text-4xl w-full pb-2">
